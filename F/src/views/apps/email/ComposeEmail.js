        ...
        >
          <CardBody className="compose-mail-body p-1">
            ...
            <div className="form-label-group pt-1">
              ...
              />
              <Label for="emailTo">Smart List</Label>
            </div>
            ...
            <div className="form-label-group">
              ...
              />
              <Label for="cc">Schedule Date</Label>
            </div>
            <div className="form-label-group">
              <Input
                id="cc"
                ...
                value={this.state.emailTime}
                onChange={e => this.setState({ emailTime: e.target.value })}
              />
              <Label for="cc">Schedule Time</Label>
            </div>
            <div className="form-label-group">
              <Input
                id="template"
