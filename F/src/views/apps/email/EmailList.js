...
import {GetAllEmailList, moveMail} from "../../../redux/actions/mymoney/index"
...
class EmailList extends React.Component {
  ...
  async componentDidMount() {
    ...
    await this.props.GetAllEmailList()
    // console.log(this.props)
    this.setState({
      mails: this.props.allEmailList
  ...
  render() {
    ...
    const mailsArr = this.props.allEmailList ? this.props.allEmailList : mails
    const renderMails =
      mailsArr.length > 0 ? (
        mailsArr.map(mail => {
          return (
                  ...
                  <div className="mail-items">
                    <span className="float-right">
                      {/* {Array.isArray(mail) ? (
                        ...
                        <span
                          className={`bullet ${mail.category} bullet-sm mr-1`}
                        />
                      )} */}
