...
import {
    Printer,
    Phone,
    User, Copy, Paperclip, BookOpen, DollarSign,PenTool
} from "react-feather"
        ...
        return (
            ...
            <div className="list-icon">
                ...
                <Col lg="12">
                    ...
                    <Button.Ripple color="warning">Edit</Button.Ripple>
                    <Button.Ripple color="danger" style={{marginLeft:"10px"}}>Delete</Button.Ripple>
              </Col>
