...
// import MissYouHistory from "./MissYouHistory"
// import Appointment from "./Appointmnet"
      ...
      <React.Fragment>
            ...
            <Row>
              <Col lg="4" md="12">
                <Card>
                    <CardHeader className="pd-add cd-h card-blue">
                        <CardTitle style={{textAlign:"center",fontSize:"16px",color:"white"}}>This Week</CardTitle>
                    </CardHeader>
             ...
             <Col lg="4" md="12">
                <Card>
                    <CardHeader className="pd-add cd-h card-blue">
                        <CardTitle style={{textAlign:"center",fontSize:"16px",color:"white"}}>Next Month</CardTitle>
                    </CardHeader>
             ...
             <Col lg="4" md="12">
                <Card>
                    <CardHeader className="pd-add cd-h card-red">
                        <CardTitle style={{textAlign:"center",fontSize:"16px",color:"white"}}>Birthday's Checklist History</CardTitle>
                    </CardHeader>
