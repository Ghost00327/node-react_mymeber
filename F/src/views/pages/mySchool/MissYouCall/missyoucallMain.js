...
import tablemissyoucall from "./tablemissyoucall"
      ...
      <React.Fragment>
            ...
            <Row>
              <Col lg="4" md="12">
                <Card>
                    <CardHeader className="pd-add cd-h card-blue">
                        <CardTitle style={{textAlign:"center",fontSize:"16px",color:"white"}}>7-14 Days Missed</CardTitle>
                    </CardHeader>
             ...
             <Col lg="4" md="12">
                <Card>
                    <CardHeader className="pd-add cd-h card-blue">
                        <CardTitle style={{textAlign:"center",fontSize:"16px",color:"white"}}>31-60 Days Missed</CardTitle>
                    </CardHeader>
             ...
             <Col lg="4" md="12">
                <Card>
                    <CardHeader className="pd-add cd-h card-red">
                        <CardTitle style={{textAlign:"center",fontSize:"16px",color:"white"}}>Miss You History Call</CardTitle>
                    </CardHeader>
