...
import { editMembership } from '../../../../redux/actions/shop/index';
...
class EditModal extends React.Component {
    ...
    onsubmit = (e) => {
        ...
        this.props.editMembership(this.state, this.props.userinfo._id);
...
export default connect(mapStateToProps, { editMembership })(EditModal)
