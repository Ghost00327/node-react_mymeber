...
import {
  ...
  EDIT_SUB_EMAIL_LIBRARY,
  EDIT_MAIN_EMAIL_LIBRARY,
  ADD_NEW_EMAIL_LIBRARY,
  ADD_NEW_SUB_EMAIL_LIBRARY
...
class FloatingLabels extends React.Component {
  ...
  componentDidMount() {
    this.props.GET_CATEGORIES_LIBRARY();
  }
  ...
  handleSubmit = e => {
    ...
    if (this.props.isEditMainFolder) {
      this.props.EDIT_MAIN_EMAIL_LIBRARY({ ...rest }, this.props.mainFolder);
      this.props.handleClose()
    } else if (this.props.isEditSubFolder) {
      this.props.EDIT_SUB_EMAIL_LIBRARY({ folderName: this.state.categoryName }, this.props.subFolder);
      this.props.handleClose()
    } else if (this.state.categoryName != "" && !this.props.isSaveCompose) {
      if (this.props.isSubFolder) {
        this.props.ADD_NEW_SUB_EMAIL_LIBRARY({ folderName: this.state.categoryName }, this.props.mainFolder);
        this.props.handleClose()
      } else {
        this.props.ADD_NEW_EMAIL_LIBRARY({ ...rest });
        this.props.handleClose()
      }
      ...
      if(!this.state.selectedSubFolder!=undefined){
        this.props.ADD_TEMPLATE_TO_LIBRARY(paylaod, this.state.selectedSubFolder)
        this.props.handleClose()
      }else{
